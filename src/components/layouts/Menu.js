    ...
    render() {
        return (
            <Fragment>
                ...
                <Link className="navbar-brand" to="/"> <img src={process.env.PUBLIC_URL + "/assets/img/spclogo.png"} alt="logo" /> </Link>
                {/* Menu */}
                <ul className="navbar-nav">
                    ...
                    {/* <li className="menu-item menu-item-has-children">
                        <Link to="/legal">Development Management</Link>
                        <ul className="submenu">
                            <li className="menu-item"> <Link to="/">Home v1</Link> </li>
                            <li className="menu-item"> <Link to="/home-v2">Home v2</Link> </li>
                            <li className="menu-item"> <Link to="/home-v3">Home v3</Link> </li>
