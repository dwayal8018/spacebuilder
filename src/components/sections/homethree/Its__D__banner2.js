...
const bannerpost = [
    ...
    {
        id: 4,
        img: 'assets/img/banner/f44.jpg',
        // img: 'assets/img/banner/baner88.png',
        img1: 'assets/img/banner/xyz1.jpg',
...
{/* Added by Its__D__ */}
                                {/* <div className="row order-1" >
                                    <div className="col-12 col-lg-4 col-xs-4 d-flex flex-column justify-content-center  align-items-center  ">
                                        <div className="row">
